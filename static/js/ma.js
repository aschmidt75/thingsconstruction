...
//    console.log(tplhtml)
    ...
    // update toc data
    try {
        var items = document.getElementById('toc_actions_info').innerText;
        document.getElementById('toc_actions_info').innerText = ""+(Number(items)+1);
    } catch (e) {
        document.getElementById('toc_actions_info').innerText = "-";
    }
